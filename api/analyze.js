...
Q|[a compelling discipleship-focused insight or question]|[start timestamp MM:SS]-[end timestamp MM:SS]|[2-3 sentence caption written for a believer who wants to grow — theologically honest, reflective, inviting depth, never shallow. End with exactly one relevant hashtag (e.g. #PrayerLife #GrowingInFaith #BiblicalTruth) followed by #CityLightChurch #Vicksburg]`
    : clipMode === 'custom'
    ? 'Find the TOP 5 culturally resonant questions this sermon answers. Real questions people in 2026 are genuinely asking. No churchy language. Written for someone who may not attend church.\n\nFor each question format EXACTLY as one line:\nQ|[sharp culturally relevant question]|[start timestamp MM:SS]-[end timestamp MM:SS]|[2-3 sentence social media caption that intrigues a skeptic, not preachy. End with exactly one relevant hashtag followed by #CityLightChurch #Vicksburg]'
